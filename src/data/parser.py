class PersonParser:
    def parse_persons(self, db):
        ...
        for url in urls:
            ...
            self.__parse_person_from(raw_persons, raw_roles, raw_relations)

    def __parse_person_from(self, raw_persons, raw_roles, raw_relations):
        return dict(
            ...
            relations=self.__parse_relations(raw_relations)
        )
    ...
    def __parse_relations(self, raw_relations):
        pass
